						...
						<div class="panel panel-default">
							<div class="panel-body">
								...
								<div class="table-container">
									<%
										Noticia nuevaNoticia = (Noticia) request.getAttribute("nuevaNoticia");
									
										if(nuevaNoticia != null)
										{
									%>
									<div class="alert alert-success" role="alert">
											Noticia <strong><%=nuevaNoticia.getShortDescription()%></strong> creada con éxito.
									</div>
									<%	
										}
									...
									<a href="/ProductorConsumidor"><button type="button" class="btn btn-primary center-block">Crear Noticia</button></a>
								</div>
							</div>
						</div>
